...
public class LinkedListTest {
    ...
    public void testListAdd() {
        final DsaList<Integer> intDsaList = new DsaLinkedList<>();
        intDsaList.add(10);
    ...
    public void testListAddIndex() {
        DsaList<Integer> intDsaList = new DsaLinkedList<>();
        intDsaList.add(0, 10);
        intDsaList.add(20);
        intDsaList.add(0, 30);
        ...
        /*test with capacity*/
        final DsaList<Integer> newDsaList = new DsaLinkedList<>();
        newDsaList.add(0);
        for (int i = 0; i < 10; i++) {
            newDsaList.add(0, i);
        }
    ...
    public void testGetCapacity() {
        DsaList<Integer> intDsaList = new DsaLinkedList<>();
        Assertions.assertThrows(UnsupportedOperationException.class, () -> intDsaList.getCapacity());
    }
    ...
    public void testListContains() {
        DsaList<String> intDsaList = new DsaLinkedList<>();
